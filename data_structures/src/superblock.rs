...
impl SuperBlockState {
    ...
    pub fn new(superblock_genesis_hash: Hash, bootsrap_committee: Vec<PublicKeyHash>) -> Self {
        let mut hs = HashSet::new();
        hs.extend(bootsrap_committee.iter().cloned());
        Self {
    ...
    /// Returns ahe last superblock hash and index.
...
mod tests {
    ...
    fn superblock_state_second_superblock_none() {
        ...
        expected_sbs.current_superblock_hash = _sb1.hash();
        assert_eq!(sbs, expected_sbs);
    }
